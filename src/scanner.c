...
//     lexer->result_symbol = CF_TAG_START;

//     return true;
    
// }

// static bool scan_cftag_end(TSLexer *lexer) {
    
//     advance(lexer);
    
//     lexer->mark_end(lexer);

//     lexer->result_symbol = CF_TAG_END;
