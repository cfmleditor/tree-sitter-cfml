...
module.exports = function defineGrammar(dialect) {
  return grammar({
    ...
    rules: {
      ...
      args: _ => keyword('arguments'),
      request: _ => keyword('request'),
      variables: _ => keyword('variables'),
      form: _ => keyword('form'),
      url: _ => keyword('url'),
      server: _ => keyword('server'),
      session: _ => keyword('session'),
      application: _ => keyword('application'),
      client: _ => keyword('client'),
      cgi: _ => keyword('cgi'),
      true: _ => keyword('true'),
