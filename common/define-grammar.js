...
module.exports = function defineGrammar(dialect) {
  return grammar({
    ...
    rules: {
      ...
      cf_component_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('component'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_silent_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('silent'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_thread_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('thread'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_execute_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('execute'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_mailpart_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('mailpart'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_selfclose_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
      ...
      cf_switch_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('switch'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_defaultcase_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('defaultcase'),
        repeat($.cf_attribute),
        alias($._close_tag_delim, '>'),
      ...
      cf_return_tag: $ => prec.right(2, seq(
        $._cf_open_tag,
        keyword('return'),
        optional($.expression),
        $.cf_selfclose_tag_end,
